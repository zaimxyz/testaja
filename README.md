...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/testaja)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/testaja
```

A live public deployment of this template is available at [https://testaja.templates.workers.dev](https://testaja.templates.workers.dev)
